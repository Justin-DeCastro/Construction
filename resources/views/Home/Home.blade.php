                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select border-0" style="height: 55px;">
                                        ...
                                        <option value="1">Residential Renovation</option>
                                        <option value="2">Commercial Renovation</option>
                                        <option value="3">Furniture Customization</option>
                                        <option value="4">Inline Store Fit-Out</option>
                                    </select>
                                </div>
                                <div class="col-12 col-sm-6">
