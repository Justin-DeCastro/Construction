                                            ...
                                            <tbody>
                                                @foreach ($quotations as $quotation)
                                                    <tr>
                                                        ...
                                                        <td>{{ ucfirst($quotation->type_of_project) }}</td>
                                                        <td>{{ $quotation->estimated_budget }}</td>
                                                        <td>{{ $quotation->project_description }}</td>
                                                        <td>{{ \Carbon\Carbon::parse($quotation->estimated_completion_date)->format('F d, Y') }}</td>
                                                        <td>{{ $quotation->additional_information }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
